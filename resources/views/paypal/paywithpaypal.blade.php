    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <br/><br/><h4><b>MAESTRO DEL FITNESS® <br> Il Percorso di allenamento Online per raggiungere i tuoi
                        obiettivi!</b></h4>
                <div class="box box-default">
                    <div class="box-body">
                        <div class="alert alert-info alert-dismissible" style="background: #f6f6f6; color: black;">
                            <p style="color:#928780;">Attraverso questo servizio di coaching one-to-one, Maestro del
                                Fitness® provvederà a crearti un programma di allenamento personalizzato , ti darà la
                                motivazione necessaria per raggiungere i tuoi obiettivi, e ti darà consigli su uno stile
                                di vita sano e attivo.
                                Accedendo al tuo account Dedicato MaestroDelFitness® ti sarà possibile controllare,
                                ovunque e in qualsiasi momento, il tuo programma di allenamento o scaricarlo in PDF e
                                averlo sempre sui tuoi dispositivi.
                            </p>
                        </div>
                    </div>
                    <!-- /.box-body -->
                ...
                <p>INIZIA UN PROGRAMMA SU MISURA PER TE
                    Non esiste un programma di allenamento che possa andare bene per tutti. Per questo Maestro del
                    Fitness® ne crea uno adatto al tuo livello, in base ai tuoi obiettivi e alle attrezzature di cui
                    disponi.
                    ...
                    NESSUN ABBONAMENTO MENSILE. PAGHI SOLO UNA VOLTA. Riceverai un accesso dedicato al tuo programma
                    dopo esserti registrato al sistema aver compilato il tuo Questionario, i tuoi progressi e il tuo
                    programma saranno sempre disponibili, potrai inoltre aggiungere altri programmi acquistando ancora.
                </p>
                ...
                <div class="box box-default">
                    <div class="box-body">
                        <div class="alert alert-info alert-dismissible" style="background: #f6f6f6; color: black;">
                            ...
                            <p style="color:#928780;">Dopo l'acquisto potrai registrarti e accedere al nostro portale e
                                compilare il nostro questionario grazie al quale creeremo il tuo Personalizzato in sole
                                48 ore!</p>
                        </div>
                    </div>
                    <!-- /.box-body -->
                ...
                <div class="box box-default">
                    <div class="box-body">
                        <div class="alert alert-info alert-dismissible" style="background: #f6f6f6; color: black;">
                            ...
                            <p style="color:#928780;">Per questo programma pagherai una volta sola senza avere
                                abbonamenti o costi fissi mensili "nascosti"! Qualora non fossi sicuro del tuo acquisto,
                                il programma richiede qualche giorno per essere creato quindi hai tutto il tempo per
                                richiedere il Rimborso completo.</p>
                        </div>
                    </div>
                    <!-- /.box-body -->
                </div>
                <div class="box box-default">
                    <div class="box-body">
                        <div class="alert alert-info alert-dismissible" style="background: #f6f6f6; color: black;">
                            ...
                            <p style="color:#928780;">Dalla consegna del programma potrai iniziare quando vuoi e avrai
                                ACCESSO PER SEMPRE al programma acquistato.
                                Paga in modo 100% sicuro tramite Paypal, con il tuo account paypal o utilizzando la tua
                                carta di credito.
                            </p>
                        </div>
                    </div>
                            ...
                            <div class="box-body">
                                <div class="alert alert-info alert-dismissible"
                                    ...
                                    <p style="color:#928780;">Scrivici <a
                                                href="mailto:info@maestrodelfitness.com">info@maestrodelfitness.com</a>
                                    </p>
                                </div>
