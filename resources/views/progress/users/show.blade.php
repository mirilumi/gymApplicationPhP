    ...
    <div class="row" style="background-color: white;color: black">
        <div class="card">
                        ...
                        <form method="POST" action="{!! url('girocoscia/'.$value->id) !!}">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <input id="girocoscia" type="number" class="form-control" value="{{$value->girocoscia}}" name="girocoscia" disabled>
                                </div>
                                <div class="col-md-6">
                                    <label for="date">Date</label>
                                    <input type="date" name="date" class="form-control" value="{{$value->date->format('Y-m-d')}}" disabled>
            ...
            @foreach($girovita as $key => $value)
                @if($key == 0)
                    <div class="col-md-4">
                        <a href=" {!! url('chart/girovita/0') !!}" class="btn btn-dark">Vedi Grafico</a>
                    </div>
                @else
                    <div class="col-md-4">
                    </div>
                        ...
                        <form method="POST" action="{!! url('girovita/'.$value->id) !!}">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <input id="girovita" type="number" class="form-control" value="{{$value->girovita}}" name="girovita" disabled>
                                </div>
                                <div class="col-md-6">
                                    <label for="date">Date</label>
                                    <input type="date" name="date" class="form-control" value="{{$value->date->format('Y-m-d')}}" disabled>
            ...
            @foreach($fianchi as $key => $value)
                @if($key == 0)
                    <div class="col-md-4">
                        <a href=" {!! url('chart/fianchi/0') !!}" class="btn btn-dark">Vedi Grafico</a>
                    </div>
                @else
                    <div class="col-md-4">
                    </div>
                        ...
                        <form method="POST" action="{!! url('fianchi/'.$value->id) !!}">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <input id="fianchi" type="number" class="form-control" value="{{$value->fianchi}}" name="fianchi" disabled>
                                </div>
                                <div class="col-md-6">
                                    <label for="date">Date</label>
                                    <input type="date" name="date" class="form-control" value="{{$value->date->format('Y-m-d')}}" disabled>
                        ...
                        <form method="POST" action="{!! url('cft/'.$value->id) !!}">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <input id="circonferenza_toracia" type="number" class="form-control" value="{{$value->circonferenza_toracia}}" name="fianchi" disabled>
                                </div>
                                <div class="col-md-6">
                                    <label for="date">Date</label>
                                    <input type="date" name="date" class="form-control" value="{{$value->date->format('Y-m-d')}}" disabled>
