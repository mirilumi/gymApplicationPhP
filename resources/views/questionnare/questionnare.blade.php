        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    ...
                    <form action="{{route('questionnare.store')}}" method="POST" >
                        @csrf
                        <br>
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <input id="email" type="email" class="form-control{{ $errors->has('email') ? ' is-invalid' : '' }}" placeholder="La tua Email" name="email" value="{{ $user->email }}" required>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <input id="pesso" type="text" class="form-control" placeholder="Your answer" name="pesso" value="{{ old('pesso') }}"  autofocus>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            ...
                            <input id="ALLENATO_FIRST" type="radio" name="allenato" value="ALLENATO_FIRST">SI (Da un periodo minore a quello di un anno)
                            <br>
                            <input id="ALLENATO_FIRST" type="radio" name="allenato" value="ALLENATO_SECOND">Si (Da un periodo maggiore a quello di un anno)<br>
                            <input id="ALLENATO_FIRST" type="radio" name="allenato" value="ALLENATO_THIRD">No non sono allenato<br>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            ...
                            <input id="STRUTTURA_PROGRAMMA_FIRST" type="radio" name="struttura_programma" value="STRUTTURA_PROGRAMMA_FIRST">1<br>
                            <input id="STRUTTURA_PROGRAMMA_SECOND" type="radio" name="struttura_programma" value="STRUTTURA_PROGRAMMA_SECOND">2<br>
                            <input id="STRUTTURA_PROGRAMMA_THIRD" type="radio" name="struttura_programma" value="STRUTTURA_PROGRAMMA_THIRD">3<br>
                            <input id="STRUTTURA_PROGRAMMA_FORTH" type="radio" name="struttura_programma" value="STRUTTURA_PROGRAMMA_FORTH">4<br>
                            <input id="STRUTTURA_PROGRAMMA_FIFTH" type="radio" name="struttura_programma" value="STRUTTURA_PROGRAMMA_FIFTH">5<br>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            ...
                            <input id="DURATA_ALLENAMENTO_FIRST" type="radio" name="durata_allenamento" value="DURATA_ALLENAMENTO_FIRST">40 / 60 MINUTI<br>
                            <input id="DURATA_ALLENAMENTO_SECOND" type="radio" name="durata_allenamento" value="DURATA_ALLENAMENTOA_SECOND">60 /90 MINUTI<br>
                            <input id="DURATA_ALLENAMENTO_THIRD" type="radio" name="durata_allenamento" value="DURATA_ALLENAMENTO_THIRD">90 /180 MINUTI<br>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            ...
                            <input id="SIXTH_QUESTION_FIRST" type="radio" name="sixth_question" value="SIXTH_QUESTION_FIRST" required>AUMENTO FORZA<br>
                            <input id="SIXTH_QUESTION_SECOND" type="radio" name="sixth_question" value="SIXTH_QUESTION_SECOND">TONIFICAZIONE / DIMAGRIMENTO<br>
                            <input id="SIXTH_QUESTION_THIRD" type="radio" name="sixth_question" value="SIXTH_QUESTION_THIRD">RESISTENZA<br>
                            <input id="SIXTH_QUESTION_FORTH" type="radio" name="sixth_question" value="SIXTH_QUESTION_FORTH">AUMENTO MASSA<br>
                            <input id="SIXTH_QUESTION_FIFTH" type="radio" name="sixth_question" value="SIXTH_QUESTION_FIFTH">ALTRO<br>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            ...
                            <input id="SEVENTH_QUESTION_FIRST" type="radio" name="seventh_question" value="SEVENTH_QUESTION_FIRST" required>Palestra<br>
                            <input id="SEVENTH_QUESTION_SECOND" type="radio" name="seventh_question" value="SEVENTH_QUESTION_SECOND">A casa con l'aiuto di Attrezzi<br>
                            <input id="SEVENTH_QUESTION_THIRD" type="radio" name="seventh_question" value="SEVENTH_QUESTION_THIRD">A casa senza l'aiuto di alcun Attrezzo<br>
                            <input id="SEVENTH_QUESTION_FORTH" type="radio" name="seventh_question" value="SEVENTH_QUESTION_FORTH">All'Aperto senza l'uso di Attrezzi<br>
                            <input id="SEVENTH_QUESTION_FIFTH" type="radio" name="seventh_question" value="SEVENTH_QUESTION_FIFTH">All'Aperto con l'uso di Attrezzi<br>
