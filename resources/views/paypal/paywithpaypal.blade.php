                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-10">
                                ...
                                <select id="amount" name="amount" class="form-control">
                                    <option value="60">&euro;60 - Programma Personalizzato Basic</option>
                                    <option value="90">&euro;90 - Programma Personalizzato Pro</option>
                                    <option value="120">&euro;120 - Programma Personalizzato Plus</option>
                                </select>
                            </div>
                            <div class="col-md-1"></div>
                        </div>
