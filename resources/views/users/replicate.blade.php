                        ...
                        <table id="datatable" class="table table-striped table-bordered">
                            ...
                            <tr>
                                <form action="{{route('admin.usersTable.store')}}" method="POST" >
                                    ...
                                    <td><input name="repetizioni" type="text" value="{{$replicatable->repetizioni}}"/></td>
                                    <td><input name="recupero" type="text" value="{{$replicatable->recupero}}"/></td>
                                    <td><input name="note" type="text" value="{{$replicatable->note}}"/></td>
