            ...
            <div class="x_panel" style="background-color: white;color: black">
                <div class="x_content" style="background-color: white;color: black">
                    ...
                    @if(isset($secondBoxTables[0]->title) && isset($secondBoxTables[0]->description))
                        <div>
                            <h3>{{$secondBoxTables[0]->title}}</h3>
                            <p>{{$secondBoxTables[0]->description}}</p>
                        </div>
                    @endif
                    @if(isset($thirdBoxTables[0]->image) || isset($thirdBoxTables[0]->description))
                        <div class="row">
                            ...
                            @if(isset($thirdBoxTables[0]->image))
                                <div class="col-md-6">
                                    ...
                                    <img src="{{asset('img/').'/'.$thirdBoxTables[0]->image}}"  class="img-responsive center-block"alt="Logo" />
                                </div>
                            @endif
                            <br>
                            <br>
